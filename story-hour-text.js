const storyHourText = `Knowing that Mrs. Mallard was afflicted with a heart trouble, great care was taken to break to her as gently as possible the news of her husband's death.
...
const storyHourLowerCaseText = storyHourText.toLowerCase();

const storyHourRepairText = storyHourLowerCaseText
    .replaceAll('"', '')
    .replaceAll('--', '')
    .replaceAll('?', '')
    .replaceAll(")", '')
